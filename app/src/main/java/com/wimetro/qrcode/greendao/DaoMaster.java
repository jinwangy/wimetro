...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        MoblieDao.createTable(db, ifNotExists);
        StationDao.createTable(db, ifNotExists);
        StationCacheDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        MoblieDao.dropTable(db, ifExists);
        StationDao.dropTable(db, ifExists);
        StationCacheDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(MoblieDao.class);
        registerDaoClass(StationDao.class);
        registerDaoClass(StationCacheDao.class);
