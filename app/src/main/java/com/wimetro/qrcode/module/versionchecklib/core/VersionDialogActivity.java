...
import com.wimetro.qrcode.module.versionchecklib.callback.APKDownloadListener;
import com.wimetro.qrcode.module.versionchecklib.callback.CommitClickListener;
import com.wimetro.qrcode.module.versionchecklib.callback.DialogDismissListener;
...
//    private Bundle paramBundle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setCommitClickListener(new CommitClickListener() {
            @Override
            public void onCommitClick() {
                Log.e("Listener" , "onCommitClick");
            }
        });
        setDialogDimissListener(new DialogDismissListener() {
            @Override
...
//        paramBundle = getIntent().getBundleExtra(AVersionService.VERSION_PARAMS_EXTRA_KEY);
    ...
    protected void showVersionDialog() {
        if (!isDestroy) {
            versionDialog = new AlertDialog.Builder(this,android.R.style.Theme_Material_Light_Dialog_Alert).setTitle(title).setMessage(updateMsg).setPositiveButton(getString(R.string.versionchecklib_confirm), new DialogInterface.OnClickListener() {
                @Override
    ...
    public void showLoadingDialog(int currentProgress) {
        ...
        if (!isDestroy) {
            if (loadingDialog == null) {
                ...
                loadingDialog = new AlertDialog.Builder(this,android.R.style.Theme_Material_Light_Dialog_Alert).setTitle("").setView(loadingView).create();
...
//            loadingDialog.setOnDismissListener(dismissListener);
    ...
    public void showFailDialog() {
        if (!isDestroy) {
            if (failDialog == null) {
                failDialog = new AlertDialog.Builder(this,android.R.style.Theme_Material_Light_Dialog_Alert).setMessage(getString(R.string.versionchecklib_download_fail_retry)).setPositiveButton(getString(R.string.versionchecklib_confirm), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        if (commitListener != null)
                            commitListener.onCommitClick();
