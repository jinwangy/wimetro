package com.wimetro.qrcode.module.versionchecklib.core.http;
...
//    }
    ...
    private static <T extends Request.Builder> T assembleHeader(T builder, VersionParams versionParams) {
        com.wimetro.qrcode.module.versionchecklib.core.http.HttpHeaders headers = versionParams.getHttpHeaders();
        if (headers != null) {
            ALog.e("header:");
